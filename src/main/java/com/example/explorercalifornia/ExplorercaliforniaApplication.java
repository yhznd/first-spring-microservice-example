package com.example.explorercalifornia;

import com.example.explorercalifornia.model.Difficulty;
import com.example.explorercalifornia.model.Region;
import com.example.explorercalifornia.service.TourPackageService;
import com.example.explorercalifornia.service.TourService;
...
public class ExplorercaliforniaApplication implements CommandLineRunner
{
	...
	public static void main(String[] args) {
		SpringApplication.run(ExplorercaliforniaApplication.class, args);
	}
	...
	public void run(String... args) throws Exception
	{
		...
		long numOfTourss = tourService.total();
